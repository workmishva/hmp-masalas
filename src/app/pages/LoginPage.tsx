...
import { Mail, Phone, ArrowRight, Sparkles, ShieldCheck, Lock, Eye, EyeOff } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';

export default function LoginPage() {
  const { user, loginWithEmail, signInWithGoogle, sendPhoneOtp, setupRecaptcha } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden bg-stone-50 dark:bg-stone-950">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-32 -bottom-32 h-96 w-96 rounded-full bg-amber-600/8 blur-3xl" />
        <div className="absolute left-1/2 top-1/3 h-64 w-64 -translate-x-1/2 rounded-full bg-red-900/5 blur-2xl" />
      </div>
      ...
      >
        <div className="rounded-3xl border border-stone-200/80 dark:border-stone-800/80 bg-white/90 dark:bg-stone-900/90 backdrop-blur-xl shadow-2xl shadow-stone-900/5 dark:shadow-black/20 overflow-hidden">
              ...
              >
                {method === tab && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-xl bg-gradient-to-r from-red-800 to-red-900 shadow-md shadow-red-900/20"
              ...
              {method === 'email' ? (
                ...
                >
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-800/60 pl-11 pr-4 py-3.5 text-stone-900 dark:text-white placeholder:text-stone-400 focus:border-red-800 focus:ring-2 focus:ring-red-800/20 outline-none transition-all"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-800/60 pl-11 pr-12 py-3.5 text-stone-900 dark:text-white placeholder:text-stone-400 focus:border-red-800 focus:ring-2 focus:ring-red-800/20 outline-none transition-all"
                      />
                      <button
                        type="button"
                  ...
                  <button
                    ...
                    className="group w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-800 to-red-900 py-3.5 text-sm font-bold text-white shadow-lg shadow-red-900/20 hover:shadow-xl hover:shadow-red-900/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                ...
                >
                  <div>
                    ...
                    <div className="relative flex">
                      ...
                      <input
                        ...
                        maxLength={10}
                        className="w-full rounded-r-xl border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-800/60 px-4 py-3.5 text-stone-900 dark:text-white placeholder:text-stone-400 focus:border-red-800 focus:ring-2 focus:ring-red-800/20 outline-none transition-all"
                      />
                    </div>
                  </div>
                  <div id="recaptcha-container" className="w-full flex justify-center" />
                  <button
                    type="submit"
                  ...
                  <div className="flex items-start gap-2 text-xs text-stone-400 dark:text-stone-500">
                    ...
                    <span>A 6-digit OTP will be sent via SMS to your phone.</span>
                  </div>
                </motion.form>
              )}
            </AnimatePresence>
          ...
          {/* Footer */}
          <div className="border-t border-stone-100 dark:border-stone-800 px-8 py-5 text-center space-y-2">
            <p className="text-sm text-stone-500 dark:text-stone-400">
              Don't have an account?{' '}
              <Link to="/signup" state={{ from: location.state?.from }} className="font-semibold text-amber-600 dark:text-amber-400 hover:underline transition-colors">
                Create Account
              </Link>
            </p>
            <p className="text-xs text-stone-400 dark:text-stone-500">
              By continuing, you agree to our{' '}
              <span className="font-medium text-stone-600 dark:text-stone-300 hover:underline cursor-pointer">Terms</span>
              {' & '}
              <span className="font-medium text-stone-600 dark:text-stone-300 hover:underline cursor-pointer">Privacy Policy</span>
            </p>
          </div>
        </div>
      </motion.div>
